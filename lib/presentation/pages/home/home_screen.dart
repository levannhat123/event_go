...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _startAutoSlide() {
    _timer = Timer.periodic(Duration(seconds: 3), (timer) {
      if (_currentIndex < boadingData.length - 1) {
        _currentIndex++;
      } else {
        _currentIndex = 0;
      }
                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            RankedEventCard(imageUrl: AppImage.banner_1, rank: 1),
                            RankedEventCard(imageUrl: AppImage.banner_2, rank: 2),
                            RankedEventCard(imageUrl: AppImage.banner_3, rank: 3),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text('Xem thêm', style: TextStyle(color: AppColors.grey)),
                            SizedBox(width: 5),
                            Icon(
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          LocationCard(imageUrl: AppImage.location_hn, locationName: 'Hà Nội'),
                          SizedBox(width: 10),
                          LocationCard(
                          ...
                          SizedBox(width: 10),
                          LocationCard(imageUrl: AppImage.location_dalat, locationName: 'Đà Lạt'),
                          SizedBox(width: 10),
                          LocationCard(
            ...
            children: [
              Positioned.fill(
                child: ClipRRect(
                  ...
                  child: Image.asset(boadingData[index]['image']!, fit: BoxFit.cover),
                ),
              ),
              Positioned(
                bottom: 10,
                ...
                child: Row(
                  ...
                  children: List.generate(boadingData.length, (index) {
                    return Container(
                      height: 8.0,
